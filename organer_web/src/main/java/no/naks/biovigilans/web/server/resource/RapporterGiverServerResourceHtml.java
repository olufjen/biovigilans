...
// Denne client resource forholder seg til src/main/resource katalogen !!!	
	     ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/rapporter_giver.html"));
...
//		 String stedx = giverKomplikasjon.getBehandlingssted();
...
//	                MediaType.TEXT_HTML);
	     ...
	     /*
	        Directory directory = new Directory(getContext(), "file:///cellerogvev/img/");
 ...
 */
    		Map<String,String> donasjonMap = donasjon.getFormMap();
    		String dKey = "type-tapping";
