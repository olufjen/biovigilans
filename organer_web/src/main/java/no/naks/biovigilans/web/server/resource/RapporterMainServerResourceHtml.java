...
public class RapporterMainServerResourceHtml extends SessionServerResource {
	...
	public Representation getHemovigilans() {
	     ...
	     Request request = getRequest();
	  	...
	  	sessionAdmin.setChosenDB(request, "organer");
...
// Denne client resource forholder seg til src/main/resource katalogen !!!	
	     ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/rapporter_hendelse_main.html"));
 ...
 */
    		...
    		if (logout != null || lukk != null){
	    		...
	    		ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/Logout.html"));
	    		Representation pasientkomplikasjonFtl = clres2.get();
...
//    		System.out.println("Status = "+result.getStatus());
    		// Denne client resource forholder seg til src/main/resource katalogen !!!	
    		ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/organer.html"));
    		Representation pasientkomplikasjonFtl = clres2.get();
    		//        Representation pasientkomplikasjonFtl = new ClientResource(LocalReference.createClapReference(getClass().getPackage())+ "/html/nymeldingfagprosedyre.html").get();
    		//        Representation pasientkomplikasjonFtl = new ClientResource("http:///no/naks/server/resource"+"/pasientkomplikasjon.ftl").get();
    		templateRep = new TemplateRepresentation(pasientkomplikasjonFtl, dataModel,
