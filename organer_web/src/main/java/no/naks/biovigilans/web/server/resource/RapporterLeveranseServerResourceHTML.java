 ...
 /*	    String melderEpost = melderwebModel.getMelder().getMelderepost();
	 ...
	 */
    	 ...
    	 if (transfusjon != null){
    		 ...
    		 sendMeldingtilsaksbehandlere("Organer Transfusjonshendelse", "Det er mottatt en transfusjonsmelding :  Meldingsnøkkel "+meldingsNokkel);
    	 ...
    	 if (giverModel != null){
    		 ...
    		 sendMeldingtilsaksbehandlere("Organer Donorhendelse", "Det er mottatt en donormelding :  Meldingsnøkkel "+meldingsNokkel);
    	 }
    	 if (annenModel != null){
    		 ...
    		 sendMeldingtilsaksbehandlere("Organer Annen hendelse", "Det er mottatt en annen melding :  Meldingsnøkkel "+meldingsNokkel);
    	 }
...
//    	 dato = melding.getVigilans().getDatoforhendelse();
    	...
    	// invalidateSessionobjects();
    	 ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/leveranse.html"));
