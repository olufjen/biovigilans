...
//Denne client resource forholder seg til src/main/resource katalogen !!!	
	     ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/meldingframelder.html"));
...
//		        	 dataModel.put(tilmelderKey, melder);
//		        	 dataModel.put(meldingtilMelderKey, melding);
		 	    	ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/meldingframelder.html"+paramMessage));
