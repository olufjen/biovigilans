...
// Denne client resource forholder seg til src/main/resource katalogen !!!	
	     ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/rapporter_transfusjon.html"));
 ...
 */
	    			...
	    			if (transfusjon.getTransfusjon().getTildigerKomplikasjon() != null && transfusjon.getTransfusjon().getTildigerKomplikasjon().equals(autolog))
	    				transfusjon.getTransfusjon().setTildigerKomplikasjon("Nei");
	    			String[] keys = transfusjon.getFormNames();
	    			/*
	    			 * For at valg av flere organer skal lagres riktig    		
	    			 */
	    			    		Map<String,String> donasjonMap = transfusjon.getFormMap();
	    			    		String dKey = "p-antistoff-transfusjon";
	    			    		...
	    			    		dKey = "p-antistoff-transfusjon";
	    			    		donasjonMap.put(dKey, organ);	    			
...
//	    			klassifikasjon.setMeldeidannen(meldeid);
	    			...
	    			///ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/rapporter_transfusjonkvittering.html"));
		    		///Representation pasientkomplikasjonFtl = clres2.get();
		    		//        Representation pasientkomplikasjonFtl = new ClientResource(LocalReference.createClapReference(getClass().getPackage())+ "/html/nymeldingfagprosedyre.html").get();
		    		//        Representation pasientkomplikasjonFtl = new ClientResource("http:///no/naks/server/resource"+"/pasientkomplikasjon.ftl").get();
		    		
		    		///templateRep = new TemplateRepresentation(pasientkomplikasjonFtl, dataModel,MediaType.TEXT_HTML);
	    			redirectPermanent("../organer/rapporter_kontakt.html");
	    		}else{
	    		

					ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/rapporter_kontakt.html"));
		    		Representation pasientkomplikasjonFtl = clres2.get();
		    		//        Representation pasientkomplikasjonFtl = new ClientResource(LocalReference.createClapReference(getClass().getPackage())+ "/html/nymeldingfagprosedyre.html").get();
		    		//        Representation pasientkomplikasjonFtl = new ClientResource("http:///no/naks/server/resource"+"/pasientkomplikasjon.ftl").get();
