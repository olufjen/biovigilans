	...
	public Representation getHemovigilans() {
	     ...
	     if (melder == null){
	        ...
	        dataModel.put( meldeTxtId, meldingsText);
	    	 page = "../organer/startside.html";	
		     LocalReference pakke = LocalReference.createClapReference(LocalReference.CLAP_CLASS,
	                 "/organer");
		     LocalReference localUri = new LocalReference(reference);
		     ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/organer/startside.html"));
...
//	     dataModel.put(melderNokkel,melder);
		 ...
		 if (!toPDF)
			 page =  "../organer/rapporter_andrehendelser.html";
...
//		    			klassifikasjoner.add(komplikasjonsklassifikasjon);
		  ...
		  if (giverKomplikasjon != null && melding != null){
			  if (!toPDF)
				  page =  "../organer/rapporter_giver.html";
...
//		      giverModel.setGiverKomplikasjon(giverKomplikasjon);
		  ...
		  if (pasientKomplikasjon != null && melding != null){
			  if (!toPDF)
				  page =  "../organer/rapporter_transfusjon.html";
