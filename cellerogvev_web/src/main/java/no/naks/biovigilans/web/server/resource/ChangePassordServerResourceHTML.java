...
public class ChangePassordServerResourceHTML extends SessionServerResource {
	...
	public Representation getHemovigilans() {
	     ...
	     Map<String, Object> dataModel = new HashMap<String, Object>();
	 	 ...
	 	 String correctPage = "/cellerogvev/endrepassordok.html";
	 	 String page = "/cellerogvev/endrepassord.html";
	     ...
	     if (passordEndring != null && passordEndring.equals(passordGitt)){
	    	 page = "/cellerogvev/endrebrukerpassord.html";
	     }
	     if (passordEndring != null && passordEndring.equals(passordIGitt)){
	    	 page = "/cellerogvev/endrebrukerpassordutenmelderinfo.html";
	     }	     
    ...
    public Representation storeHemovigilans(Form form) {
    	TemplateRepresentation  templateRep = null;
 	    ...
 	    String meldingsText = "Passordet har ikke nok styrke, vennligst prøv igjen";
	 	 String correctPage = "/cellerogvev/endrepassordok.html";
	 	 String incorrectPage = "/cellerogvev/endrepassordfeilpassord.html";
	 	 String page = "/cellerogvev/endrepassord.html";
	    Request request = getRequest();
	    melderwebModel =(MelderwebModel) sessionAdmin.getSessionObject(request,melderId);
	    String chPW = melderwebModel.getChangePasswd();
...
//	    String page = "../cellerogvev/melder_rapport.html"; 
		...
		if(tilKontaksSkjema != null) {
			page = "../cellerogvev/rapporter_kontakt.html";
			origpasswd = null;
			sessionAdmin.setSessionObject(getRequest(),origpasswd,origpasswdID);
		     ClientResource clres2 = new ClientResource(LocalReference.createClapReference(LocalReference.CLAP_CLASS,"/cellerogvev/changepassord.html"));
		     Representation pasientkomplikasjonFtl = clres2.get();
		        TemplateRepresentation  templatemapRep = new TemplateRepresentation(pasientkomplikasjonFtl,dataModel,
		                MediaType.TEXT_HTML);
				redirectPermanent(page);
